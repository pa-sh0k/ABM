...
from AgentBasedModel import plot_inventories, plot_hpe_price, plot_hfts_in_panic, plot_cash, plot_and_save_equity_avg
...
for scenario, scenario_configs in configs.items():
    ...
    for config_i, config in enumerate(scenario_configs):
        ...
        for _ in range(len(infos)):
            ...
            # plot_and_save_equity_avg(infos[_], save_path=f"output/plots/{config_i}_hfts_equity_avg_{_}.png")
